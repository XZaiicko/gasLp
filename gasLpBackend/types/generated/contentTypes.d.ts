...
export interface ApiClienteCliente extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    domicilios: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiDomicilioDomicilio extends Struct.CollectionTypeSchema {
  collectionName: 'domicilios';
  info: {
    displayName: 'domicilio';
    pluralName: 'domicilios';
    singularName: 'domicilio';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    colonia: Schema.Attribute.String & Schema.Attribute.Required;
    cp: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    estado: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
...
export interface ApiEstadoServicioEstadoServicio
  extends Struct.CollectionTypeSchema {
  collectionName: 'estado_servicios';
  info: {
    displayName: 'estado_servicio';
    pluralName: 'estado-servicios';
    singularName: 'estado-servicio';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiServicioServicio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    domicilio: Schema.Attribute.Relation<
      'manyToOne',
      'api::domicilio.domicilio'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::domicilio.domicilio': ApiDomicilioDomicilio;
      'api::estado-servicio.estado-servicio': ApiEstadoServicioEstadoServicio;
